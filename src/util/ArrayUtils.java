...
public class ArrayUtils {
    ...
    */
    ...
    public static String toString(List<Integer> list, String itemFormat) {
        if (list == null) {
            return null;
        }
    ...
    */
    ...
    /**
     * Конвертация массива строк в двухмерный список чисел List<List<Integer>>
     */
    public static List<List<Integer>> toIntList2(String[] lines) {
        List<List<Integer>> list2 = new ArrayList<>();
        for (String line : lines) {
            list2.add(toIntList(line));
        }
        return list2;
    }
    ...
    public static void writeListToFile(String fileName, List<Integer> list, String itemFormat)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println(toString(list, itemFormat));
        }
    }
    ...
    public static void writeListToFile(String fileName, List<Integer> list)
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println(toString(list, null));
        }
    }
    ...
    public static List<Integer> readIntListFromFile(String fileName) {
        return toIntList(fileName);
    }

    /**
     * Чтение двумерного списка из текстового файла
     */
    public static List<List<Integer>> readIntList2FromFile(String fileName) {
        try {
            return toIntList2(readLinesFromFile(fileName));
        }
        catch(IOException e) {
            return null;
        }
